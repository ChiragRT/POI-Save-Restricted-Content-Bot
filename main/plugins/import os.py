...
S = "/start"
START_PIC = "https://telegra.ph/file/158d26492e7791bda32c7.jpg"
...
async def start_command(event):
    ...
    buttons = [
        ...
        [Button.url("Join Channel", url="https://t.me/testing_join")]
    ]
...
M = "/plan"
PREMIUM_PIC = "https://telegra.ph/file/158d26492e7791bda32c7.jpg"
...
async def plan_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Send Gift Card Code", url="https://t.me/Poi_fwd")],
        [Button.url("Join Channel", url="https://t.me/testing_join")]
    ]
...
T = "/terms"
TERM_PIC = "https://telegra.ph/file/158d26492e7791bda32c7.jpg"
...
async def term_command(event):
    # Creating inline keyboard with buttons
    buttons = [
        [Button.url("Have a Query?", url="https://t.me/testing_join")],
         [Button.url("Join Channel", url="https://telegram.dog//testing_join")]
    ]
