...
def thumbnail(sender):
    return f'{sender}.png' if os.path.exists(f'{sender}.png') else f'thumb.png'
        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[Team Rowdy](https://t.me/testing_join)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[Team Rowdy](https://t.me/testing_join)**__" if msg.caption else "__Unrestricted by **[Team Rowdy](https://t.me/testing_join)**__"
                await client.send_video(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading: [Team Rowdy](https://t.me/testing_join)__**\n ',
                        upm,
                        time.time()
                    )
                )
                ...
                await client.send_document(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading:__**\n**__Bot made by [Team Rowdy](https://t.me/testing_join)__**',
                        upm,
                        time.time()
                    )
                )
